...
namespace TCPService
{
    ...
    public class TCPSocketListener
    {
        ...
        /// for an end of file and in return the SocketListener sends the total
        ...
        //private void execMacro(string strCommand, string strCommandParameters){ 
        private void execMacro(){

            /*
                cmd = start, pathExec = C:\Program Files(x86)\Google\Chrome\Application\chrome.exe\, param1 = http://www.kree8tive.dk }
            */

            //string strCommand = "C:\Program Files(x86)\Google\Chrome\Application\chrome.exe";
            string strCommand = "chrome.exe";
            string strCommandParameters = "http://www.kree8tive.dk";
